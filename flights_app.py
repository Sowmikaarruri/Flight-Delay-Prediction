    ...
    if app_mode == 'Login':
        ...
        if st.button("Login"):
            if check_login(username, password):
                ...
                st.rerun()  # Rerun the script to load the selected page
            else:
        ...
        if st.button("Register"):
            ...
            st.rerun() # Rerun the script to load the prediction page
        ...
        if st.session_state['logged_in']:
            ...
            st.write("DEBUG - Reserved Flights in session:", reserved_flights)
